...
class AssistantMethods
{
  ...
  {
    double timeTraveledFareAmountPerMinute = (directionDetailsInfo.duration_value! / 60) * 4;
    double distanceTraveledFareAmountPerKilometer = (directionDetailsInfo.duration_value! / 1000) *4;
